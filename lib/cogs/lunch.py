...
async def setup(bot):
    ...
    bot.tree.add_command(lunchonline, guild=discord.Object(id=533019434491576323))
    bot.tree.add_command(lunchonline, guild=discord.Object(id=220180151315595264))
    bot.tree.add_command(lunchonline, guild=discord.Object(id=484582649965576199))
